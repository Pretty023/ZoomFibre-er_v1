...
const ResellerApplicationFormContainer = ({ navigation, route }) => {
	...
	return (
		<View style={[{ flex: 1 }]}>
			...
			<ScrollView style={[Gutters.smallVPadding, Gutters.regularHPadding, { backgroundColor: Colors.dark_white }]}
				contentContainerStyle={[Layout.scrollSpaceBetween, { paddingTop: 250 }]} onScroll={({ nativeEvent }) => {
...
export default ResellerApplicationFormContainer
